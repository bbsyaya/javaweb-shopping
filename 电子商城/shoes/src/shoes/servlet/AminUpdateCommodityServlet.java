...
/**
 * Servlet implementation class AminUpdateCommodityServlet
 */
@WebServlet("/admin/AminUpdateCommodityServlet")
public class AminUpdateCommodityServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AminUpdateCommodityServlet() {
        super();
