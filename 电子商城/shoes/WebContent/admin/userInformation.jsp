<%@page import="shoes.serviceImpl.UserServiceImpl"%>
<%@page import="shoes.service.UserService"%>
...
<div class="nav-navicon admin-main admin-sidebar">
    ...
    <div class="sideMenu">
      ...
      <h3 class="am-icon-users on"><em></em> <a href="userInformation.jsp?#">会员管理</a></h3>
      <ul>
        <li>会员列表 </li>
        <li>未激活会员</li>
        <li>团队系谱图</li>
...
<div class="am-popup am-popup-inner" id="my-popup" >
      ...
      <form class="am-form tjlanmu" action="AdminAddUserServlet">
	...
	<div class="am-popup am-popup-inner" id="my-popups">
     ...
     <form class="am-form tjlanmu" action="AdminUpdateUserServlet" method="post">
		<div class="am-form-group am-cf">
...
<div class="admin-biaogelist">
    ...
    <form class="am-form am-g">
          <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped">
            ...
            <%
            	...
            	int page_count;//总页数
          		int p;//当前页数
          		int size = 15;//每页记录数
          		int result_count  = service.countOfRows();//总记录数
          		...
          		begin = (p-1)*size;
            	ArrayList<UserBean> beans = service.queryAllOrderPage(begin, size);
                ...
                <td>
                    ...
                    <div class="am-btn-group am-btn-group-xs">
                     ...
                     <intput type="button" onclick="window.location.href='AdminDeleteUserServlet?id=<%=user.getId() %>'"  class="am-btn am-btn-default am-btn-xs am-text-danger am-round" title="删除订单"><span class="am-icon-trash-o" ></span></intput>
                    </div>
                  </div>
                </td>
              </tr>
         ...
         <%
          	if(p!=1) out.print("<li><a href='userInformation.jsp?page="+1+"'"+">«</a></li>");
          %>
          <%
          	if(p>1) out.print("<li><a href='userInformation.jsp?page="+(p-1)+"'"+">‹</a></li>");
          %>
          <%
          	for(int i=3;i>=1;i--){
				if(p-i>=1){
          %>
          <li class=""><a href="userInformation.jsp?page=<%=p-i%>"><%=p-i %></a></li>
          <%}} %>
          <li class="am-active"><a href="userInformation.jsp?page=<%=p%>"><%=p %></a></li>
          <%
          	for(int i=1;i<=3;i++){
				if(p+i<=page_count){
          %>
          ...
          <%}} %>
          <%
          	if(p<page_count) out.print("<li><a href='userInformation.jsp?page="+(p+1)+"'"+">›</a></li>");
          %>
          <%
          	if(p!=page_count)	out.print("<li><a href='userInformation.jsp?page="+page_count+"'"+">»</a></li>");
          %>
